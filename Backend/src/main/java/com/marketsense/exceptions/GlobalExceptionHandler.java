...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleSameAccount(SameAccountException exception) {
        ProblemDetail errorDetail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(409), exception.getMessage());
        errorDetail.setProperty("field", "recipientAccountNumber");
        return errorDetail;
    }
    ...
    public ProblemDetail handleEmailTaken(EmailTakenException exception) {
        ProblemDetail errorDetail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(409), exception.getMessage());
        errorDetail.setProperty("field", "email");
        return errorDetail;
    }
    ...
    public ProblemDetail handleResourceNotFound(ResourceNotFoundException exception) {
        ...
        errorDetail.setProperty("field", "resource");
        return errorDetail;
    }
    ...
    public ProblemDetail handleInvalidPassword(InvalidPasswordException exception) {
        ...
        errorDetail.setProperty("field", "currentPassword");
        return errorDetail;
    }

    @ExceptionHandler(SamePasswordException.class)
    public ProblemDetail handleSamePassword(SamePasswordException exception) {
        ProblemDetail errorDetail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(400), exception.getMessage());
        errorDetail.setProperty("field", "confirmPassword");
        return errorDetail;
    }
